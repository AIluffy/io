...
3. Query 升级场景补读：
   - [Query v0.1 Breaking Changes](/migration/query-v0-1-breaking-changes/)
   - [Migration: client.query -> defineQuery/observeQuery](/migration/query-v0-1-client-query-to-define-observe/)
4. 最后按本页验收清单做上线前检查。
