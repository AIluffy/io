...
export type IoLynxInfiniteQueryResult<
  TData,
  TError = Error,
  TPageParam = unknown,
  TSelected = InfiniteData<TData, TPageParam>,
...
>(
  ...
  const infiniteQuery = useMemo(() => {
    ...
    const current = optionsRef.current as IoUseInfiniteQueryDefinitionOptions<
      TData,
      TError,
      TPageParam,
      TSelected
...
export type IoLynxSuspenseInfiniteQueryResult<
  TData,
  TError = Error,
  TPageParam = unknown,
  TSelected = InfiniteData<TData, TPageParam>,
...
>(
  ...
  return result as IoLynxSuspenseInfiniteQueryResult<
    TData,
    TError,
    TPageParam,
    TSelected
